import { defineConfig, presetWind4, presetAttributify, presetIcons, presetWebFonts, presetTypography, transformerDirectives, transformerVariantGroup } from "unocss";
...
export default defineConfig({
  ...
  rules: [["text-50px", { "font-size": "50px" }]]
});
